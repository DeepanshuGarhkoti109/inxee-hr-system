// ignore_for_file: prefer_const_constructors, unused_import, unused_field, avoid_print, sized_box_for_whitespace, avoid_unnecessary_containers, use_build_context_synchronously
...
class _ApplyLeaveState extends State<ApplyLeave> {
  ...
  String _range = '';
  String _rangeCount = '';
  DateTime _firstDate = DateTime.parse('20000101');
  DateTime _lastDate = DateTime.parse('20000101');
  String _application = '';
    ...
    setState(() {
      if (args.value is PickerDateRange) {
        ...
        if (selectedDates.isNotEmpty) {
          ...
          _firstDate = selectedDates.first;
          final lastSelectedDate = selectedDates.last;
          _lastDate = selectedDates.last;
                      ...
                      return AlertDialog(
                        ...
                        actions: <Widget>[
                          ...
                          TextButton(
                            child: Text('Submit'),
                            onPressed: () async {
                              LeaveMethods().applyLeave(
                                  email: await getEmail(),
                                  start: Timestamp.fromDate(_firstDate),
                                  end: Timestamp.fromDate(_lastDate),
                                  title: _applicationTitleController
                                      .text,
